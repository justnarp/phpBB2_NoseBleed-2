...
<tr> 
	...
	<td class="{pending_members_row.ROW_CLASS} three txtcenter"><input type="checkbox" class="checkbox" name="pending_members[]" value="{pending_members_row.USER_ID}" checked="checked" /></td>
</tr>
<!-- END pending_members_row -->
<tr> 
	<td class="row1 pad4 txtright" colspan="7"><input type="submit" name="approve" value="{L_APPROVE_SELECTED}" class="button" />&nbsp;<input type="submit" name="deny" value="{L_DENY_SELECTED}" class="button" /></td>
</tr>